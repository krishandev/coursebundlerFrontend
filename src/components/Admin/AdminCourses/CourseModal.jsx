            ...
            <Box px={['0', '16']}>
                ...
                
                {
                    lectures.map((item, i)=>(
                        ...
                        key={i}
                title="React Intro"
                description="This is a React Intro Video, Where you will learn basics of React"
                num={i+1}
                lectureId="lectureiddddddd"
                courseId={id}
            ...
            <Box>
                <form onSubmit={e=>addLectureHandler(e, id, title, description, video)}>
                    <VStack spacing={'4'}>
                        ...
                        <Input type={'file'} required accept='video/mp4' focusBorderColor='purple.300' css={{'&::file-selector-button':{
          ...fileUploadCss, 
          color:'purple'

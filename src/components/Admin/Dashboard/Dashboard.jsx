...
const Bar=({title, value, profit})=>(
  ...
  <Box py={'4'} px={['0', '20']}>
    ...
    >
      ...
      <Progress w={'full'} colorScheme={`${value>0?'purple':'red'}`} value={profit?value:0}/>
...
const Dashboard = () => {
  return (
    ...
    <Heading children="Dashboard" textAlign={['center', 'left']} ml={['0', '16']} mb={'16'}/>

    <Stack direction={['column', 'row']} minH='24' justifyContent={'space-evenly'} >

      <Databox title="View" qty={123} qtyPercentage={30} profit={true}/>
      <Databox title="Users" qty={50} qtyPercentage={78} profit={true}/>
      <Databox title="Subscription" qty={20} qtyPercentage={40} profit={false}/>
    ...
    <Grid templateColumns={['1fr', '2fr 1fr']}>
      <Box p={'4'}>
        <Heading children="Progress Bar" textAlign={['center', 'left']} size={'md'} my={'8'} ml={['0', '16']}/>
